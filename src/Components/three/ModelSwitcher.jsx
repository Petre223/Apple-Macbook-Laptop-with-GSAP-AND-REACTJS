...
const ModelSwitcher = ({ scale, isMobile }) => {
    ...
    useGSAP(() => {
        if (showLargeMacbook) {
        if (smallMacbookRef.current) moveGroup(smallMacbookRef.current, -OFFSET_DISTANCE);
        ...
        if (largeMacbookRef.current) moveGroup(largeMacbookRef.current, OFFSET_DISTANCE);
